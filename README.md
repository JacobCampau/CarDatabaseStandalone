...
A standalone version of my [Original Car Database](https://github.com/JacobCampau/CarDatabase.git) project. The original project required the user to set values in the code, download the dataset, and run the PostgreSQL on their device before running the application. 
